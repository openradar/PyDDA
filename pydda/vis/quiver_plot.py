...
def plot_horiz_xsection_quiver(Grids, ax=None,
    ...
    The rest of the options will put the quiver key in that particular part of 
    the plot, near the edge inside the plot if not outside.
...
def plot_horiz_xsection_quiver_map(Grids, ax=None,
    ...
    """
    This procedure plots a horizontal cross section of winds from wind fields
    generated by PyDDA using quivers. The length of the quivers varies with 
    wind speed.
    ...
    particular part of the plot, near the edge inside the plot if not outside.
